...
def make_mapper(df1, df2, address1_column_name, address2_column_name, name1, name2, fuzz_thresh=60):
    ...
    merge_df[['id','facility_id','permit_number','name', 'restaurant_name', 'address_x', 'address_y', 'fuzz_ratio']].to_csv('final_model_data/mapper_all_matches.csv')
...
if __name__ == '__main__':
    ...
    # mapper.to_csv('final_model_data/mapper.csv')
    ...
    # yelp_reviews_with_period.to_csv('final_model_data/yelp_reviews_with_period.csv')
    ...
    with open('final_model_data/model.pkl', 'wb') as f:
        pickle.dump(model, f)
